...
tape( 'the function returns `true` if every iterated value passes a test implemented by a predicate function (value+done)', function test( t ) {
	var bool;
	var arr;
...
tape( 'the function returns `false` if at least one iterated value fails a test implemented by a predicate function (value+done)', function test( t ) {
	var bool;
	var arr;
